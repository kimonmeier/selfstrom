...
namespace SelfStrom.Server.Services
{
    public class EmailSender : IEmailSender<ApplicationUser>
    {
        ...
        public async Task SendConfirmationLinkAsync(ApplicationUser user, string email, string confirmationLink)
        {
            ...
            builder.AppendLine("<p>Self-Strom Team</p>");

            await this.SendEmailAsync(email, "Confirm Account", builder.ToString());
        }
        ...
        public async Task SendPasswordResetLinkAsync(ApplicationUser user, string email, string resetLink)
        {
            ...
            await this.SendEmailAsync(email, "Forgotten Password Link", builder.ToString());
        }
